...
16. [Execution and approval policy](approval-policy.md)
17. [Protocol baseline](protocol/README.md)
18. [CLI agent adapter evaluation](agent-adapter-evaluation.md)
19. [Alpha UX flows](ux-flows.md)
20. [Sequential implementation backlog](implementation-backlog.md)
21. [Licensing and contribution policy](licensing-policy.md)
22. [CI and supply-chain baseline](ci-supply-chain.md)
23. [Identity-provider decision](decisions/0007-identity-provider.md)
24. [Proposed cryptographic architecture](decisions/0008-cryptographic-architecture.md)
25. [Cryptographic design-review packet](cryptographic-design-review.md)
26. [AI-assisted cryptographic pre-review](cryptographic-design-pre-review.md)
27. [C-007 cryptographic remediation plan](cryptographic-remediation-plan.md)
28. [Pairing and recovery ceremonies](protocol/pairing-and-recovery.md)
29. [Sender-authenticated content and PTY channels](protocol/sender-authenticated-content.md)
30. [Nonce, crash, restore, and retry state](protocol/nonce-and-retry-state.md)
31. [Cryptographic byte profile v1](protocol/cryptographic-byte-profile.md)
32. [C-007-R6 platform-boundary prototype](../apps/mobile/spikes/cryptographic-boundaries/README.md)
